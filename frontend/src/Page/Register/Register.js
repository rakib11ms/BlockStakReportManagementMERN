                                            ...
                                            <form class="row g-4" onSubmit={handleSubmit}>
                                                <div className='col-md-6'>
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            ...
                                                            <input type="text" class="form-control" value={phone} onChange={(e) => setPhone(e.target.value)} placeholder="Enter Phone" />
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                ...
                                                <div className='col-md-6'>
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div class="d-flex my-2 mb-3">
                                                            <div class="form-check mx-2">
                                                                <input class="form-check-input" type="checkbox" value="black" id="flexCheckDefault" onChange={handleFavColorChange} />
                                                                <label class="form-check-label" for="flexCheckDefault">
                                                                    Black
                                                                </label>
                                                            </div>
                                                            <div class="form-check mx-2">
                                                                <input class="form-check-input" type="checkbox" value="red" id="flexCheckDefault" onChange={handleFavColorChange} />
                                                                <label class="form-check-label" for="flexCheckDefault">
                                                                    Red
                                                                </label>
                                                            </div>
                                                            <div class="form-check mx-2">
                                                                <input class="form-check-input" type="checkbox" value="white" id="flexCheckDefault" onChange={handleFavColorChange} />
                                                                <label class="form-check-label" for="flexCheckDefault">
                                                                    White
                                                                </label>
                                                            </div>
                                                            <div class="form-check mx-2">
                                                                <input class="form-check-input" type="checkbox" value="others" id="flexCheckDefault" onChange={handleFavColorChange} />
                                                                <label class="form-check-label" for="flexCheckDefault">
                                                                    Others
                                                                </label>
                                                            </div>
                                                    ...
                                                    <div class="col-12 d-flex justify-content-between align-items-center">
                                                        <Link to="/login" class="float-end text-primary text-underline mt-4">Login</Link>
                                                        <button type="submit" class="btn btn-primary px-5 py-2 float-end mt-4">Register</button>
